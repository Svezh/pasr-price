...
def PlotBilder(ref):
    def ref_search(ref):
        ...
        if ref == "5E 650i":
            ...
            df_ref = pd.DataFrame(pd.read_csv('refs/5E_2000i_ref.csv', sep=','))  #
            ...
            df_ref = pd.DataFrame(pd.read_csv('refs/5P_1550IR_ref.csv', sep=','))  #

        elif ref == "5P 1550IRT":
            df_ref = pd.DataFrame(pd.read_csv('refs/5P_1550IRT_ref.csv', sep=','))  #
            ...
            df_ref = pd.DataFrame(pd.read_csv('refs/5SC_1500i_ref.csv', sep=','))  #

        elif ref == "5SC 1000IR":
            df_ref = pd.DataFrame(pd.read_csv('refs/5SC_1500ir_ref.csv', sep=','))  #

        elif ref == "5SC 1500IR":
            df_ref = pd.DataFrame(pd.read_csv('refs/5SC_1500ir_ref.csv', sep=','))  #

        elif ref == "5SC 2200IRT":
            df_ref = pd.DataFrame(pd.read_csv('refs/5SC_2200IRT_ref.csv', sep=','))  #

        elif ref == "5SC 3000IRT":
            df_ref = pd.DataFrame(pd.read_csv('refs/5SC_3000IRT_ref.csv', sep=','))  #

        elif ref == "5E 500i":
            df_ref = pd.DataFrame(pd.read_csv('refs/5E_500i_ref.csv', sep=','))  #

        elif ref == "3S 450DIN":
            df_ref = pd.DataFrame(pd.read_csv('refs/3S_450DIN_ref.csv', sep=','))  #

        elif ref == "3S 550DIN":
            df_ref = pd.DataFrame(pd.read_csv('refs/33S_550DIN_ref.csv', sep=','))  #

        elif ref == "3S 700DIN":
            df_ref = pd.DataFrame(pd.read_csv('refs/3S_700DIN_ref.csv', sep=','))  #

        elif ref == "3S 850DIN":
            df_ref = pd.DataFrame(pd.read_csv('refs/3S_850DIN_ref.csv', sep=','))  #

        elif ref == "5PX 1500iRT":
            df_ref = pd.DataFrame(pd.read_csv('refs/5PX_1500iRT_ref.csv', sep=','))  #

        elif ref == "5PX 2200iRT":
            df_ref = pd.DataFrame(pd.read_csv('refs/5PX_2200iRT_ref.csv', sep=','))  #

        elif ref == "5PX 3000iRT":
            df_ref = pd.DataFrame(pd.read_csv('refs/5PX_3000iRT_ref.csv', sep=','))  #

        elif ref == "5PX 3000iRTN":
            df_ref = pd.DataFrame(pd.read_csv('refs/5PX_3000iRTN_ref.csv', sep=','))  #
    ...
    def converter(converting_df, df_ref):
        ...
        converting_df = converting_df.fillna('1')
        df_comp = converting_df.loc[
            (converting_df['Model'].isin(df_ref['ART_Model'])) | (converting_df['Model'].isin(df_ref['Name_Model']))]
    ...
    if df_comp.empty & df_comp_cit.empty:
        ...
        df_ref_cit = df_ref.loc[
            (df_ref['ART_Model'].isin(df_comp_cit['Model'])) | (
                df_ref['Name_Model'].isin(df_comp_cit['Model']))]
